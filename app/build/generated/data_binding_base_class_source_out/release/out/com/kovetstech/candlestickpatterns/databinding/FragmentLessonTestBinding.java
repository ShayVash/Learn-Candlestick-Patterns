...
public final class FragmentLessonTestBinding implements ViewBinding {
  ...
  private FragmentLessonTestBinding(@NonNull ConstraintLayout rootView, @NonNull AdView adView,
      @NonNull View horSep2, @NonNull TextView questionAmount, @NonNull Button quizAnswer1,
      ...
      @NonNull ConstraintLayout testLayout) {
  ...
  public static FragmentLessonTestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLessonTestBinding((ConstraintLayout) rootView, adView, horSep2,
          questionAmount, quizAnswer1, quizAnswer2, quizAnswer3, quizAnswer4, quizImage,
          quizQuestion, testLayout);
    }
